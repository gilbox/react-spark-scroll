...
var SparkScroll = React.createClass({
  ...
  render: function () {
    console.log("render SparkScroll");
  ...
  componentDidMount() {
    var debounce, doCallback;
    var nonAnimatedUpdate, onInvalidate;
    var recalcFormulas, recalcMinMax;
    var setTriggerElement;
